...
check_parse "get parses arxiv id/options/range" '"range":{"start":35,"end":67}' get 2401.04088 --detailed --range 35:67 --no-refs --no-cache --no-tldr
check_parse "get parses arxiv url" '"tag":"arxiv","id":"2401.04088"' get https://arxiv.org/abs/2401.04088v2
check_parse "get parses pubmed prefix" '"tag":"pubmed","id":"38903003"' get pmid:38903003
check_parse "get parses pubmed url" '"tag":"pubmed","id":"38903003"' get https://pubmed.ncbi.nlm.nih.gov/38903003/
check_parse "get parses doi" '"tag":"doi","id":"10.1101/2023.12.15.571821"' get doi:10.1101/2023.12.15.571821
check_parse "refs parses json/max" '"tag":"refs","id":{"tag":"arxiv","id":"1706.03762"},"max":2,"json":true' refs 1706.03762 --max 2 --json
check_parse "repo parses id" '"tag":"repo"' repo 2401.04088
...
check_parse "vault export parses id" '"tag":"vault-export"' vault 2401.04088
